...
dae::SecondLevelVS::SecondLevelVS(const std::string& name) :Scene(name)
, m_GridSizeWidth(14)
, m_GridSizeHeight(19)
{
...
void dae::SecondLevelVS::Initialize()
{
...
void dae::SecondLevelVS::Render() const
{
	Scene::Render();
}

void dae::SecondLevelVS::Reset()
{
	Scene::Reset();
	m_Rocks.clear();
