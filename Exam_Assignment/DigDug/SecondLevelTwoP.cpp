...
dae::SecondLevelTwoP::SecondLevelTwoP(const std::string& name) :Scene(name)
, m_GridSizeWidth(14)
, m_GridSizeHeight(19)
{
...
void dae::SecondLevelTwoP::Initialize()
{
...
void dae::SecondLevelTwoP::Update()
{
	Scene::Update();
	if (m_PlayerOne)
	{
...
void dae::SecondLevelTwoP::Render() const
{
	Scene::Render();
}

void dae::SecondLevelTwoP::Reset()
{
	Scene::Reset();
	m_Rocks.clear();
